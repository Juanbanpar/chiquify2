                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner d-flex align-items-center">
							            <% if(session.getAttribute("email") != null) { %>
								            <%
								                if(session.getAttribute("seller") == "me")
								                {
								            %>
									            <p style="color: red; font-weight: 800;">You can't buy your own product</p>
											<%
								                }else{
								            %>
		                                        <FORM name="nombre" method="POST" action="sendconfirmation">
		                                        	<B>&emsp;&emsp;&emsp;Tarjeta de pago</B>: <BR><BR>&emsp;&emsp;&emsp;
		                                        	<INPUT type="text" pattern="^\d{16}$" placeholder="XXXX XXXX XXXX XXXX" name="tarjeta" size="60" required> <br> <BR>
