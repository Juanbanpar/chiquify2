					...
					<div class="login_form_inner">
						...
						<form class="row login_form" METHOD=POST ACTION="update">
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" required value = <% out.print(session.getAttribute("idtoEdit")); %>>
							</div>
							<div class="col-md-12 form-group">
